...
function(DATAFLOW_SOURCE_GROUP group)
  cmake_parse_arguments(DATAFLOW_SOURCE_GROUP "" "" "GLOB;GLOB_RECURSE" ${ARGN})
  if(DATAFLOW_SOURCE_GROUP_GLOB)
    file(GLOB srcs1 ${DATAFLOW_SOURCE_GROUP_GLOB})
    source_group(${group} FILES ${srcs1})
  endif()

  if(DATAFLOW_SOURCE_GROUP_GLOB_RECURSE)
    file(GLOB_RECURSE srcs2 ${DATAFLOW_SOURCE_GROUP_GLOB_RECURSE})
...
function(FindFilesMatch found_files expr)
  ...
  foreach(file_i ${${found_files}})
    file(RELATIVE_PATH relative_path ${dataflow_src_dir} ${file_i})
