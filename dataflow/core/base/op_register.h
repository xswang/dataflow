...
#define CLASS_REGISTER_OBJECT_CREATOR(register_name,                         \
                                      ...
                                      entry_name,                  \
                                      class_name)                            \
  base_class_name* ObjectCreator_##register_name##entry_name##class_name() {             \
    return new class_name;                                                   \
  }                                                                          \
                                                                             \
  ObjectCreatorRegister_##register_name                                      \
  g_object_creator_register_##register_name##entry_name##class_name(                     \
      entry_name,                                                  \
      ObjectCreator_##register_name##entry_name##class_name)



#define MATRIX_BLOB_REGISTER_CREATE_OBJECT(register_name, entry_name)    \
  GetRegistry_##register_name().CreateMatrixBlobObject(entry_name)

#define CLASS_REGISTER_CREATE_OBJECT(register_name, entry_name)    \
  GetRegistry_##register_name().CreateObject(entry_name)
